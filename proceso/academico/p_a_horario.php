			...
			<div class="lado2">
				<div class="container">
					<div class="row" style="background:#FF6C60;border-radius:.8vw .8vw 0 0;">
							<h2 style="text-align:center;color:#ffff;">Formulario de Horario</h2>
					</div>
					<br>
					<div class="row">
						<a href="p_a_h_nuevo.php" class="btn btn-primary">Nuevo Registro</a>
					</div>
					<br>
							...
							<tbody>
								<?php while($row = $resultado->fetch_array(MYSQLI_ASSOC)) { ?>
									<tr>
										...
										<td><a href="p_a_h_modificar.php?IDHorario=<?php echo $row['IDHorario']; ?>"><span class="glyphicon glyphicon-pencil"></span></a></td>
										<td><a href="p_a_h_delete.php?IDHorario=<?php echo $row['IDHorario']; ?>"><span class="glyphicon glyphicon-trash"></span></a></td>
									</tr>
								<?php } ?>
							</tbody>
						</table>
